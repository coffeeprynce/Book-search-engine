# Book-search-engine
a database engine used to search up your favorite books.



##Descriptions
A book search engine using graph ql and the apollo server.
...
``md
    I used the module 21 mini project for reference.
``
